            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h5 class="panel-title">
                        <span class="question-number">{{ $question->question_num }}</span>问题：
                        <div id="editTitle" class="input" contenteditable="true">{{ $question->title }}</div>
                    </h5>
                </div>
            ...
            <ul class="list-group">
                <li class="list-group-item">
                    ...
                    <label for="toggleReq">
                        ...
                        <input type="checkbox" name="toggleReq" id="toggleReq" {{ $question->required_question ? "checked=\"checked\"" : "" }} class="pull-left">
                    <div class="form-group">
                    <label for="editReqtext">没有回答时，显示的错误信息</label>
                        <input type="text" name="editReqtext" id="editReqtext" class="form-control" value="{{ $question->required_text }}">
                    </div>
                </li>
